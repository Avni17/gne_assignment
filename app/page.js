  ...
  return (
    <div className="flex  justify-start overflow-hidden">
      ...
      <div className="min-h-screen bg-white w-full md:w-6/7">
        ...
        <main className={`p-4 ml-auto mb-2 mr-auto lg:ml-6 lg:mr-4 mt-4 border-4 rounded overflow-auto scroll-container h-[63vh] sm:h-[70vh] ${activeTab === 'userDetails' ? 'w-[90vw] lg:w-fit' : 'w-auto'}`} >
